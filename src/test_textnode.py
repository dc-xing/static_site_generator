...
class TestTextNode(unittest.TestCase):
    ...
    def test_not_equal(self):
        node = TextNode("This is a text node", TextType.BOLD)
        node2 = TextNode("This is a text node", TextType.BOLD, "https://en.wikipedia.org/wiki/Unit_testing")
...
class TestTextNodeToHTMLNode(unittest.TestCase):
    ...
    def test_unknown_text_type(self):
        node = TextNode("This is a text node with an unknown text type", "unknown")
        with self.assertRaises(ValueError):
            text_node_to_html_node(node)
    
    def test_text_type_not_enum(self):
        node = TextNode("This is a text node with a non-enum text type", "text")
        with self.assertRaises(ValueError):
            text_node_to_html_node(node)
...
class TestSplitNodesDelimiter(unittest.TestCase):
    ...
    def test_split_nodes_delimiter_no_delimiter(self):
        old_nodes = [TextNode("This is text with no code block word", TextType.TEXT)]
        new_nodes = split_nodes_delimiter(old_nodes, "`", TextType.CODE)
        expected_nodes = [
...
class TestSplitNodesImage(unittest.TestCase):
    def test_split_nodes_image(self):
        node = TextNode("This is text with an image ![alt text](http://example.com/image.jpg) in it", TextType.TEXT)
...
class TestSplitNodesLink(unittest.TestCase):
    def test_split_nodes_link(self):
        node = TextNode("This is text with a link [link text](http://example.com) in it", TextType.TEXT)
...
class TestTextToTextNodes(unittest.TestCase):
    def test_text_to_textnodes(self):
        text = "This is **bold** text with a [link](https://boot.dev) and an ![image](https://i.imgur.com/zjjcJKZ.png)"
